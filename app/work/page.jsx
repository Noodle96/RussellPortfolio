                                ...
                                <Link href={project.live}>
                                    <TooltipProvider delayDuration={100}>
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p className='capitalize bg-white/80 text-primary p-2 rounded-xl'>Live project</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </TooltipProvider>
                                </Link>
                                ...
                                <Link href={project.github}>
                                    <TooltipProvider delayDuration={100}>
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p className='capitalize bg-white/80 text-primary p-2 rounded-xl'>Github repository</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </TooltipProvider>
                                </Link>
                                        ...
                                        <div className='h-[460px] relative group flex justify-center items-center bg-pink-50/20'>
                                            ...
                                            <div className='relative w-full h-full'>
                                                <Image
                                                    src={project.image}
                                                    fill
                                                    className='object-cover group-hover:scale-101 transition-all duration-500'
                                                    alt='image project'
                                                />
                                            </div>
                                        </div>
